...
\begin{tabular*}{\textwidth}{@{}>{\raggedright\arraybackslash}p{0.34\textwidth}>{\raggedright\arraybackslash}p{0.46\textwidth}@{\extracolsep{\fill}}r@{}}
    \textbf{微软亚洲互联网工程院 (北京)} & AI/Agent 软件工程实习生 & 2026.06 – 2026.09 \\
\end{tabular*}\titlebreak
\begin{itemize}[nosep]
    \item \textbf{Agentic 评估基础设施:} 参与演进基于 LLM-as-a-Judge 的Excel Enterprise Search Agent 评估框架，负责 Case 同步、自动评分与人工校验。重构评估器，引入Excel工作簿结果、对话响应与执行轨迹进行 Agentic 分析，实现模型推理问题与工具故障的细粒度诊断。
