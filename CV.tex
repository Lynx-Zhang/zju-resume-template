...
\begin{itemize}[nosep]
    \item \textbf{Agentic 评估基础设施:} 参与演进基于 LLM-as-a-Judge 的 Enterprise Search Agent 评估框架，负责 Case 同步、自动评分与人工校验。重构评估器，引入工作簿结果、对话响应与执行轨迹进行 Agentic 分析，实现模型推理问题与工具故障的细粒度诊断。
